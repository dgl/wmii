  ...
  \item[ctl] The client's control file, containing the following
    ...
    \begin{description}
     ...
     \item[activate] The client is allowed to activate
      ...
      \item[titleless] The client's titlebar state. When |on|,
        the client will not show a titlebar, unless the client
        is inactive in a stack. Possible values are |on|, |off|,
        and |toggle|.
